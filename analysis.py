# -*- coding: utf-8 -*-
"""
Created on Tue Jul 11 06:14:26 2023
...
print("The equivalent number of zones that would achieve the same",\
...
print(f"So while the optimal resolution value returns {round(eq_NZ/monochr,4)}, resulting from optimal value, {round(opt_val,4)},",\
